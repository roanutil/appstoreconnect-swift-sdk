...
public struct SubscriptionOfferCode: Codable, Hashable, Identifiable, Sendable {
	...
	public struct Relationships: Codable, Hashable, Sendable {
		...
		public struct OneTimeUseCodes: Codable, Hashable, Sendable {
			public var links: Links?
		...
		public struct CustomCodes: Codable, Hashable, Sendable {
			public var links: Links?
			public var meta: PagingInformation?
			public var data: [Datum]?
