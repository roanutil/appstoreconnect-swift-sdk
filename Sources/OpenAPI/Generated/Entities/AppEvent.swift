...
public struct AppEvent: Codable, Hashable, Identifiable, Sendable {
	...
	public struct Attributes: Codable, Hashable, Sendable {
		...
		public enum Badge: String, Codable, CaseIterable, Hashable, Sendable {
		...
		public enum EventState: String, Codable, CaseIterable, Hashable, Sendable {
			case draft = "DRAFT"
		...
		public enum PurchaseRequirement: String, Codable, CaseIterable, Hashable, Sendable {
		...
		public enum Priority: String, Codable, CaseIterable, Hashable, Sendable {
			case high = "HIGH"
			case normal = "NORMAL"
		}
		...
		public struct TerritorySchedule: Codable, Hashable, Sendable {
		...
		public struct ArchivedTerritorySchedule: Codable, Hashable, Sendable {
			public var territories: [String]?
			public var publishStart: Date?
			public var eventStart: Date?
			public var eventEnd: Date?
