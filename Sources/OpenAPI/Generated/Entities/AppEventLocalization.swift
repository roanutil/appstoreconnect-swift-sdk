...
public struct AppEventLocalization: Codable, Hashable, Identifiable, Sendable {
	...
	public struct Relationships: Codable, Hashable, Sendable {
		...
		public struct AppEventScreenshots: Codable, Hashable, Sendable {
			public var links: Links?
		...
		public struct AppEventVideoClips: Codable, Hashable, Sendable {
			public var links: Links?
			public var meta: PagingInformation?
			public var data: [Datum]?
