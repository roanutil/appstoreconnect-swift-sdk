...
public struct CiBuildRun: Codable, Hashable, Identifiable, Sendable {
	...
	public struct Attributes: Codable, Hashable, Sendable {
		...
		public struct SourceCommit: Codable, Hashable, Sendable {
		...
		public struct DestinationCommit: Codable, Hashable, Sendable {
			public var commitSha: String?
			public var message: String?
			public var author: CiGitUser?
			public var committer: CiGitUser?
		...
		public enum StartReason: String, Codable, CaseIterable, Hashable, Sendable {
		...
		public enum CancelReason: String, Codable, CaseIterable, Hashable, Sendable {
	...
	public struct Relationships: Codable, Hashable, Sendable {
		...
		public struct DestinationBranch: Codable, Hashable, Sendable {
			public var links: Links?
			public var data: Data?
