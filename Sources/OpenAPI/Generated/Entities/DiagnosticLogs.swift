...
public struct DiagnosticLogs: Codable, Hashable, Sendable {
	...
	public struct ProductDatum: Codable, Hashable, Sendable {
		...
		public struct DiagnosticInsight: Codable, Hashable, Sendable {
		...
		public struct DiagnosticLog: Codable, Hashable, Sendable {
			public var callStackTree: [CallStackTreeItem]?
			public var diagnosticMetaData: DiagnosticMetaData?

			public struct CallStackTreeItem: Codable, Hashable, Sendable {
				public var isCallStackPerThread: Bool?
				public var callStacks: [CallStack]?

				public struct CallStack: Codable, Hashable, Sendable {
