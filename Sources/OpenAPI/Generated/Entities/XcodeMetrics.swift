...
public struct XcodeMetrics: Codable, Hashable, Sendable {
	...
	public struct ProductDatum: Codable, Hashable, Sendable {
		public var platform: String?
		public var metricCategories: [MetricCategory]?

		public struct MetricCategory: Codable, Hashable, Sendable {
            public var identifier: Self { self }
			...
			public struct Metric: Codable, Hashable, Sendable {
				...
				public struct GoalKey: Codable, Hashable, Sendable {
				...
				public struct Dataset: Codable, Hashable, Sendable {
					...
					public struct Point: Codable, Hashable, Sendable {
						...
						public struct PercentageBreakdown: Codable, Hashable, Sendable {
							public var value: Double?
			...
			public init(metrics: [Metric]? = nil) {
