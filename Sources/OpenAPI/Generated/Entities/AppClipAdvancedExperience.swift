...
public struct AppClipAdvancedExperience: Codable, Hashable, Identifiable, Sendable {
	...
	public struct Attributes: Codable, Hashable, Sendable {
		...
		public struct Place: Codable, Hashable, Sendable {
			...
			public struct MainAddress: Codable, Hashable, Sendable {
				public var fullAddress: String?
				public var structuredAddress: StructuredAddress?

				public struct StructuredAddress: Codable, Hashable, Sendable {
			...
			public enum MapAction: String, Codable, CaseIterable, Hashable, Sendable {
			...
			public enum Relationship: String, Codable, CaseIterable, Hashable, Sendable {
				case owner = "OWNER"
		...
		public enum PlaceStatus: String, Codable, CaseIterable, Hashable, Sendable {
			case pending = "PENDING"
			case matched = "MATCHED"
			case noMatch = "NO_MATCH"
		}

		public enum BusinessCategory: String, Codable, CaseIterable, Hashable, Sendable {
	...
	public struct Relationships: Codable, Hashable, Sendable {
		...
		public struct HeaderImage: Codable, Hashable, Sendable {
			public var links: Links?
			public var data: Data?
		...
		public struct Localizations: Codable, Hashable, Sendable {
			public var links: Links?
