...
public struct CiXcodeVersion: Codable, Hashable, Identifiable, Sendable {
	...
	public struct Attributes: Codable, Hashable, Sendable {
		...
		public struct TestDestination: Codable, Hashable, Sendable {
			...
			public struct AvailableRuntime: Codable, Hashable, Sendable {
	...
	public struct Relationships: Codable, Hashable, Sendable {
		...
		public struct MacOsVersions: Codable, Hashable, Sendable {
