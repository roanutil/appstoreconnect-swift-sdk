...
public struct AppCustomProductPageCreateRequest: Codable, Hashable, Sendable {
	...
	public struct Data: Codable, Hashable, Sendable {
		...
		public struct Relationships: Codable, Hashable, Sendable {
			...
			public struct AppCustomProductPageVersions: Codable, Hashable, Sendable {
			...
			public struct AppStoreVersionTemplate: Codable, Hashable, Sendable {
				public var data: Data?
			...
			public struct CustomProductPageTemplate: Codable, Hashable, Sendable {
				public var data: Data?
