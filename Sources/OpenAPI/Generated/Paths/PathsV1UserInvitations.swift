...
extension APIEndpoint.V1 {
	...
	public struct UserInvitations {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.UserInvitationsResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "userInvitations-get_collection")
		}
		...
		public struct GetParameters {
			...
			public enum FilterRoles: String, Codable, CaseIterable, Hashable, Sendable {
				case admin = "ADMIN"
			...
			public enum FieldsUserInvitations: String, Codable, CaseIterable, Hashable, Sendable {
				case allAppsVisible
				case email
				case expirationDate
				case firstName
		...
		public func post(_ body: AppStoreConnect_Swift_SDK.UserInvitationCreateRequest) -> Request<AppStoreConnect_Swift_SDK.UserInvitationResponse> {
			Request(method: "POST", path: path, body: body, id: "userInvitations-create_instance")
		}
	}
}
