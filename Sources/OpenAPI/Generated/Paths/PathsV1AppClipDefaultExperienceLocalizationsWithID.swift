...
extension APIEndpoint.V1.AppClipDefaultExperienceLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.AppClipDefaultExperienceLocalizationResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "appClipDefaultExperienceLocalizations-get_instance")
		}
		...
		public struct GetParameters {
			...
			public enum FieldsAppClipDefaultExperienceLocalizations: String, Codable, CaseIterable, Hashable, Sendable {
			...
			public enum FieldsAppClipHeaderImages: String, Codable, CaseIterable, Hashable, Sendable {
		...
		public func patch(_ body: AppStoreConnect_Swift_SDK.AppClipDefaultExperienceLocalizationUpdateRequest) -> Request<AppStoreConnect_Swift_SDK.AppClipDefaultExperienceLocalizationResponse> {
			Request(method: "PATCH", path: path, body: body, id: "appClipDefaultExperienceLocalizations-update_instance")
		}

		public var delete: Request<Void> {
			Request(method: "DELETE", path: path, id: "appClipDefaultExperienceLocalizations-delete_instance")
		}
	}
}
