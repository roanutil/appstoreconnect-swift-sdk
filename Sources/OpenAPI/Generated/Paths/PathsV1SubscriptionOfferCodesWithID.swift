...
extension APIEndpoint.V1.SubscriptionOfferCodes {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.SubscriptionOfferCodeResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "subscriptionOfferCodes-get_instance")
		}
		...
		public struct GetParameters {
			...
			public enum FieldsSubscriptionOfferCodeCustomCodes: String, Codable, CaseIterable, Hashable, Sendable {
				case active
				case createdDate
				case customCode
				case expirationDate
			...
			public enum FieldsSubscriptionOfferCodeOneTimeUseCodes: String, Codable, CaseIterable, Hashable, Sendable {
				case active
				case createdDate
				case expirationDate
				case numberOfCodes
			...
			public enum FieldsSubscriptionOfferCodePrices: String, Codable, CaseIterable, Hashable, Sendable {
		...
		public func patch(_ body: AppStoreConnect_Swift_SDK.SubscriptionOfferCodeUpdateRequest) -> Request<AppStoreConnect_Swift_SDK.SubscriptionOfferCodeResponse> {
			Request(method: "PATCH", path: path, body: body, id: "subscriptionOfferCodes-update_instance")
		}
	}
}
