...
extension APIEndpoint.V1.BetaGroups.WithID.Relationships {
	...
	public struct BetaTesters {
		...
		public func get(limit: Int? = nil) -> Request<AppStoreConnect_Swift_SDK.BetaGroupBetaTestersLinkagesResponse> {
			Request(method: "GET", path: path, query: makeGetQuery(limit), id: "betaGroups-betaTesters-get_to_many_relationship")
		}
		...
		public func post(_ body: AppStoreConnect_Swift_SDK.BetaGroupBetaTestersLinkagesRequest) -> Request<Void> {
			Request(method: "POST", path: path, body: body, id: "betaGroups-betaTesters-create_to_many_relationship")
		}

		public func delete(_ body: AppStoreConnect_Swift_SDK.BetaGroupBetaTestersLinkagesRequest) -> Request<Void> {
			Request(method: "DELETE", path: path, body: body, id: "betaGroups-betaTesters-delete_to_many_relationship")
		}
	}
}
