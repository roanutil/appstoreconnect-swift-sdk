...
extension APIEndpoint.V1 {
	...
	public struct Profiles {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.ProfilesResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "profiles-get_collection")
		}
		...
		public struct GetParameters {
			...
			public enum FilterProfileState: String, Codable, CaseIterable, Hashable, Sendable {
				case active = "ACTIVE"
				case invalid = "INVALID"
			}

			public enum FilterProfileType: String, Codable, CaseIterable, Hashable, Sendable {
		...
		public func post(_ body: AppStoreConnect_Swift_SDK.ProfileCreateRequest) -> Request<AppStoreConnect_Swift_SDK.ProfileResponse> {
			Request(method: "POST", path: path, body: body, id: "profiles-create_instance")
		}
	}
}
