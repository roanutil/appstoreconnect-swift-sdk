...
extension APIEndpoint.V1.AppStoreVersions.WithID {
	...
	public struct CustomerReviews {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.CustomerReviewsResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "appStoreVersions-customerReviews-get_to_many_related")
		}
		...
		public struct GetParameters {
			...
			public enum FilterTerritory: String, Codable, CaseIterable, Hashable, Sendable {
				case abw = "ABW"
				case afg = "AFG"
				case ago = "AGO"
				case aia = "AIA"
			...
			public enum FieldsCustomerReviewResponses: String, Codable, CaseIterable, Hashable, Sendable {
