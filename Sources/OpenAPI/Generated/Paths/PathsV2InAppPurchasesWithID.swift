...
extension APIEndpoint.V2.InAppPurchases {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.InAppPurchaseV2Response> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "inAppPurchases-get_instance")
		}
		...
		public struct GetParameters {
			...
			public enum FieldsInAppPurchaseAvailabilities: String, Codable, CaseIterable, Hashable, Sendable {
				case availableInNewTerritories
				case availableTerritories
				case inAppPurchase
			}

			public enum FieldsInAppPurchaseAppStoreReviewScreenshots: String, Codable, CaseIterable, Hashable, Sendable {
			...
			public enum FieldsInAppPurchaseLocalizations: String, Codable, CaseIterable, Hashable, Sendable {
				case description
				case inAppPurchaseV2
				case locale
				case name
		...
		public func patch(_ body: AppStoreConnect_Swift_SDK.InAppPurchaseV2UpdateRequest) -> Request<AppStoreConnect_Swift_SDK.InAppPurchaseV2Response> {
			Request(method: "PATCH", path: path, body: body, id: "inAppPurchases-update_instance")
		}

		public var delete: Request<Void> {
			Request(method: "DELETE", path: path, id: "inAppPurchases-delete_instance")
		}
	}
}
