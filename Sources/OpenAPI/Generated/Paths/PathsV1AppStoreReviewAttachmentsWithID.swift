...
extension APIEndpoint.V1.AppStoreReviewAttachments {
	...
	public struct WithID {
		...
		public func get(fieldsAppStoreReviewAttachments: [FieldsAppStoreReviewAttachments]? = nil, include: [Include]? = nil) -> Request<AppStoreConnect_Swift_SDK.AppStoreReviewAttachmentResponse> {
			Request(method: "GET", path: path, query: makeGetQuery(fieldsAppStoreReviewAttachments, include), id: "appStoreReviewAttachments-get_instance")
		}
		...
		public enum FieldsAppStoreReviewAttachments: String, Codable, CaseIterable, Hashable, Sendable {
		...
		public func patch(_ body: AppStoreConnect_Swift_SDK.AppStoreReviewAttachmentUpdateRequest) -> Request<AppStoreConnect_Swift_SDK.AppStoreReviewAttachmentResponse> {
			Request(method: "PATCH", path: path, body: body, id: "appStoreReviewAttachments-update_instance")
		}

		public var delete: Request<Void> {
			Request(method: "DELETE", path: path, id: "appStoreReviewAttachments-delete_instance")
		}
	}
}
