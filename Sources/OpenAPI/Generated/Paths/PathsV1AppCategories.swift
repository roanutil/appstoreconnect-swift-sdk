...
extension APIEndpoint.V1 {
	...
	public struct AppCategories {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.AppCategoriesResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "appCategories-get_collection")
		}
		...
		public struct GetParameters {
			...
			public enum FilterPlatforms: String, Codable, CaseIterable, Hashable, Sendable {
				case ios = "IOS"
				case macOs = "MAC_OS"
				case tvOs = "TV_OS"
			}
