...
extension APIEndpoint.V1.Apps.WithID {
	...
	public struct AppStoreVersions {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.AppStoreVersionsResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "apps-appStoreVersions-get_to_many_related")
		}
		...
		public struct GetParameters {
			...
			public enum FilterAppStoreState: String, Codable, CaseIterable, Hashable, Sendable {
