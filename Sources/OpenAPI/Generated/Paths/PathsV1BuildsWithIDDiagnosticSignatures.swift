...
extension APIEndpoint.V1.Builds.WithID {
	...
	public struct DiagnosticSignatures {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.DiagnosticSignaturesResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "builds-diagnosticSignatures-get_to_many_related")
		}
		...
		public struct GetParameters {
			...
			public enum FilterDiagnosticType: String, Codable, CaseIterable, Hashable, Sendable {
