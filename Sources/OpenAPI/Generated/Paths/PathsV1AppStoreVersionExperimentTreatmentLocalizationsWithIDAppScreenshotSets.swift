...
extension APIEndpoint.V1.AppStoreVersionExperimentTreatmentLocalizations.WithID {
	...
	public struct AppScreenshotSets {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.AppScreenshotSetsResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "appStoreVersionExperimentTreatmentLocalizations-appScreenshotSets-get_to_many_related")
		}
		...
		public struct GetParameters {
			...
			public enum FilterScreenshotDisplayType: String, Codable, CaseIterable, Hashable, Sendable {
			...
			public enum FieldsAppScreenshotSets: String, Codable, CaseIterable, Hashable, Sendable {
			...
			public enum FieldsAppScreenshots: String, Codable, CaseIterable, Hashable, Sendable {
