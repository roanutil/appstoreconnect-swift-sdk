...
extension APIEndpoint.V1.AppStoreVersionLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.AppStoreVersionLocalizationResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "appStoreVersionLocalizations-get_instance")
		}
		...
		public func patch(_ body: AppStoreConnect_Swift_SDK.AppStoreVersionLocalizationUpdateRequest) -> Request<AppStoreConnect_Swift_SDK.AppStoreVersionLocalizationResponse> {
			Request(method: "PATCH", path: path, body: body, id: "appStoreVersionLocalizations-update_instance")
		}

		public var delete: Request<Void> {
			Request(method: "DELETE", path: path, id: "appStoreVersionLocalizations-delete_instance")
		}
	}
}
