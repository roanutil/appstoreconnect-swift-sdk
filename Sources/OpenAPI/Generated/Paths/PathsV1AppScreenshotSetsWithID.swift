...
extension APIEndpoint.V1.AppScreenshotSets {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.AppScreenshotSetResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "appScreenshotSets-get_instance")
		}
		...
		public var delete: Request<Void> {
			Request(method: "DELETE", path: path, id: "appScreenshotSets-delete_instance")
		}
	}
}
