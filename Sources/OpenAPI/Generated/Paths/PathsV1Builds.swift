...
extension APIEndpoint.V1 {
	...
	public struct Builds {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.BuildsResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "builds-get_collection")
		}
		...
		public struct GetParameters {
			...
			public enum FieldsDiagnosticSignatures: String, Codable, CaseIterable, Hashable, Sendable {
				case diagnosticType
				case logs
				case signature
				case weight
