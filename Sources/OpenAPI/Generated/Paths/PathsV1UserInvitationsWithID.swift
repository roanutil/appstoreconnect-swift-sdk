...
extension APIEndpoint.V1.UserInvitations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.UserInvitationResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "userInvitations-get_instance")
		}
		...
		public var delete: Request<Void> {
			Request(method: "DELETE", path: path, id: "userInvitations-delete_instance")
		}
	}
}
