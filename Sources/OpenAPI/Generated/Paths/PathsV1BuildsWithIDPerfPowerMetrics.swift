...
extension APIEndpoint.V1.Builds.WithID {
	...
	public struct PerfPowerMetrics {
		...
		public func get(parameters: GetParameters? = nil) -> Request<XcodeMetrics> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "builds-perfPowerMetrics-get_to_many_related")
		}
		...
		public struct GetParameters {
			...
			public enum FilterMetricType: String, Codable, CaseIterable, Hashable, Sendable {
				case disk = "DISK"
				case hang = "HANG"
