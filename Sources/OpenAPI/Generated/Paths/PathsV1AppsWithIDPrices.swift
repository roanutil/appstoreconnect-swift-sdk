...
extension APIEndpoint.V1.Apps.WithID {
	...
	public struct Prices {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.AppPricesResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "apps-prices-get_to_many_related")
		}
		...
		public struct GetParameters {
			...
			public enum FieldsAppPriceTiers: String, Codable, CaseIterable, Hashable, Sendable {
				case pricePoints
			}
