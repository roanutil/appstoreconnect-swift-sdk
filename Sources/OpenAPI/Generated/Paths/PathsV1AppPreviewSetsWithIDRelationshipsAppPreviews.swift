...
extension APIEndpoint.V1.AppPreviewSets.WithID.Relationships {
	...
	public struct AppPreviews {
		...
		public func get(limit: Int? = nil) -> Request<AppStoreConnect_Swift_SDK.AppPreviewSetAppPreviewsLinkagesResponse> {
			Request(method: "GET", path: path, query: makeGetQuery(limit), id: "appPreviewSets-appPreviews-get_to_many_relationship")
		}
		...
		public func patch(_ body: AppStoreConnect_Swift_SDK.AppPreviewSetAppPreviewsLinkagesRequest) -> Request<Void> {
			Request(method: "PATCH", path: path, body: body, id: "appPreviewSets-appPreviews-replace_to_many_relationship")
		}
	}
}
