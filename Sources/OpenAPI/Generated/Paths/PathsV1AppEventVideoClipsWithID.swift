...
extension APIEndpoint.V1.AppEventVideoClips {
	...
	public struct WithID {
		...
		public func get(fieldsAppEventVideoClips: [FieldsAppEventVideoClips]? = nil, include: [Include]? = nil) -> Request<AppStoreConnect_Swift_SDK.AppEventVideoClipResponse> {
			Request(method: "GET", path: path, query: makeGetQuery(fieldsAppEventVideoClips, include), id: "appEventVideoClips-get_instance")
		}
		...
		public enum FieldsAppEventVideoClips: String, Codable, CaseIterable, Hashable, Sendable {
		...
		public func patch(_ body: AppStoreConnect_Swift_SDK.AppEventVideoClipUpdateRequest) -> Request<AppStoreConnect_Swift_SDK.AppEventVideoClipResponse> {
			Request(method: "PATCH", path: path, body: body, id: "appEventVideoClips-update_instance")
		}

		public var delete: Request<Void> {
			Request(method: "DELETE", path: path, id: "appEventVideoClips-delete_instance")
		}
	}
}
