...
extension APIEndpoint.V1 {
	...
	public struct SalesReports {
		...
		public func get(parameters: GetParameters) -> Request<Data> {
			Request(method: "GET", path: path, query: parameters.asQuery, id: "salesReports-get_collection")
		}
		...
		public struct GetParameters {
			...
			public enum FilterFrequency: String, Codable, CaseIterable, Hashable, Sendable {
				case daily = "DAILY"
				case weekly = "WEEKLY"
			...
			public enum FilterReportSubType: String, Codable, CaseIterable, Hashable, Sendable {
				case summary = "SUMMARY"
				case detailed = "DETAILED"
			}

			public enum FilterReportType: String, Codable, CaseIterable, Hashable, Sendable {
				case sales = "SALES"
