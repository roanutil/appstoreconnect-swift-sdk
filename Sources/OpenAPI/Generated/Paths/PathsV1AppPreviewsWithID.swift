...
extension APIEndpoint.V1.AppPreviews {
	...
	public struct WithID {
		...
		public func get(fieldsAppPreviews: [FieldsAppPreviews]? = nil, include: [Include]? = nil) -> Request<AppStoreConnect_Swift_SDK.AppPreviewResponse> {
			Request(method: "GET", path: path, query: makeGetQuery(fieldsAppPreviews, include), id: "appPreviews-get_instance")
		}
		...
		public func patch(_ body: AppStoreConnect_Swift_SDK.AppPreviewUpdateRequest) -> Request<AppStoreConnect_Swift_SDK.AppPreviewResponse> {
			Request(method: "PATCH", path: path, body: body, id: "appPreviews-update_instance")
		}

		public var delete: Request<Void> {
			Request(method: "DELETE", path: path, id: "appPreviews-delete_instance")
		}
	}
}
