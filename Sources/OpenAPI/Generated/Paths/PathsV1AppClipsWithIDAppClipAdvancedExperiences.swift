...
extension APIEndpoint.V1.AppClips.WithID {
	...
	public struct AppClipAdvancedExperiences {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.AppClipAdvancedExperiencesResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "appClips-appClipAdvancedExperiences-get_to_many_related")
		}
		...
		public struct GetParameters {
			...
			public enum FilterAction: String, Codable, CaseIterable, Hashable, Sendable {
				case `open` = "OPEN"
				case view = "VIEW"
				case play = "PLAY"
			}

			public enum FilterPlaceStatus: String, Codable, CaseIterable, Hashable, Sendable {
				case pending = "PENDING"
				case matched = "MATCHED"
				case noMatch = "NO_MATCH"
			}

			public enum FilterStatus: String, Codable, CaseIterable, Hashable, Sendable {
				case received = "RECEIVED"
				case deactivated = "DEACTIVATED"
				case appTransferInProgress = "APP_TRANSFER_IN_PROGRESS"
			}

			public enum FieldsAppClipAdvancedExperiences: String, Codable, CaseIterable, Hashable, Sendable {
				case action
				case appClip
			...
			public enum FieldsAppClipAdvancedExperienceImages: String, Codable, CaseIterable, Hashable, Sendable {
			...
			public enum FieldsAppClipAdvancedExperienceLocalizations: String, Codable, CaseIterable, Hashable, Sendable {
				case language
				case subtitle
				case title
			}
