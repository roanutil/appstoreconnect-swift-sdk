...
extension APIEndpoint.V1.CiBuildRuns.WithID {
	...
	public struct Builds {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.BuildsResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "ciBuildRuns-builds-get_to_many_related")
		}
		...
		public struct GetParameters {
			...
			public enum FilterBetaAppReviewSubmissionBetaReviewState: String, Codable, CaseIterable, Hashable, Sendable {
			...
			public enum FilterBuildAudienceType: String, Codable, CaseIterable, Hashable, Sendable {
				case internalOnly = "INTERNAL_ONLY"
				case appStoreEligible = "APP_STORE_ELIGIBLE"
			}

			public enum FilterPreReleaseVersionPlatform: String, Codable, CaseIterable, Hashable, Sendable {
				case ios = "IOS"
				case macOs = "MAC_OS"
				case tvOs = "TV_OS"
			}

			public enum FilterProcessingState: String, Codable, CaseIterable, Hashable, Sendable {
			...
			public enum FieldsBuildBundles: String, Codable, CaseIterable, Hashable, Sendable {
			...
			public enum FieldsBuildIcons: String, Codable, CaseIterable, Hashable, Sendable {
				case iconAsset
				case iconType
				case name
			}

			public enum FieldsBetaAppReviewSubmissions: String, Codable, CaseIterable, Hashable, Sendable {
				case betaReviewState
				case build
				case submittedDate
			}

			public enum FieldsBuildBetaDetails: String, Codable, CaseIterable, Hashable, Sendable {
			...
			public enum FieldsBetaTesters: String, Codable, CaseIterable, Hashable, Sendable {
				case apps
				case betaGroups
				case builds
				case email
			...
			public enum FieldsBetaBuildLocalizations: String, Codable, CaseIterable, Hashable, Sendable {
				case build
				case locale
				case whatsNew
			}
