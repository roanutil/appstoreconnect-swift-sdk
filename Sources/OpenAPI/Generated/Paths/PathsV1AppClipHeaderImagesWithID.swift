...
extension APIEndpoint.V1.AppClipHeaderImages {
	...
	public struct WithID {
		...
		public func get(fieldsAppClipHeaderImages: [FieldsAppClipHeaderImages]? = nil, include: [Include]? = nil) -> Request<AppStoreConnect_Swift_SDK.AppClipHeaderImageResponse> {
			Request(method: "GET", path: path, query: makeGetQuery(fieldsAppClipHeaderImages, include), id: "appClipHeaderImages-get_instance")
		}
		...
		public func patch(_ body: AppStoreConnect_Swift_SDK.AppClipHeaderImageUpdateRequest) -> Request<AppStoreConnect_Swift_SDK.AppClipHeaderImageResponse> {
			Request(method: "PATCH", path: path, body: body, id: "appClipHeaderImages-update_instance")
		}

		public var delete: Request<Void> {
			Request(method: "DELETE", path: path, id: "appClipHeaderImages-delete_instance")
		}
	}
}
