...
extension APIEndpoint.V1.AppInfos {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.AppInfoResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "appInfos-get_instance")
		}
		...
		public struct GetParameters {
			...
			public enum FieldsAppCategories: String, Codable, CaseIterable, Hashable, Sendable {
				case parent
				case platforms
				case subcategories
			}
		...
		public func patch(_ body: AppStoreConnect_Swift_SDK.AppInfoUpdateRequest) -> Request<AppStoreConnect_Swift_SDK.AppInfoResponse> {
			Request(method: "PATCH", path: path, body: body, id: "appInfos-update_instance")
		}
	}
}
