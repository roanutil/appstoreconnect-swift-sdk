...
extension APIEndpoint.V1.BetaAppClipInvocations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.BetaAppClipInvocationResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "betaAppClipInvocations-get_instance")
		}
		...
		public struct GetParameters {
			...
			public enum FieldsBetaAppClipInvocations: String, Codable, CaseIterable, Hashable, Sendable {
		...
		public func patch(_ body: AppStoreConnect_Swift_SDK.BetaAppClipInvocationUpdateRequest) -> Request<AppStoreConnect_Swift_SDK.BetaAppClipInvocationResponse> {
			Request(method: "PATCH", path: path, body: body, id: "betaAppClipInvocations-update_instance")
		}

		public var delete: Request<Void> {
			Request(method: "DELETE", path: path, id: "betaAppClipInvocations-delete_instance")
		}
	}
}
