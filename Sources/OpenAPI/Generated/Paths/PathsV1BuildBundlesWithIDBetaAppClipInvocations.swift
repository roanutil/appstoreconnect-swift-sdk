...
extension APIEndpoint.V1.BuildBundles.WithID {
	...
	public struct BetaAppClipInvocations {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.BetaAppClipInvocationsResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "buildBundles-betaAppClipInvocations-get_to_many_related")
		}
		...
		public struct GetParameters {
			...
			public enum FieldsBetaAppClipInvocationLocalizations: String, Codable, CaseIterable, Hashable, Sendable {
