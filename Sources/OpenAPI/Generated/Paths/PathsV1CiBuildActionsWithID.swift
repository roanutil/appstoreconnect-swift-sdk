...
extension APIEndpoint.V1.CiBuildActions {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.CiBuildActionResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "ciBuildActions-get_instance")
		}
		...
		public struct GetParameters {
			...
			public enum FieldsCiBuildActions: String, Codable, CaseIterable, Hashable, Sendable {
				case actionType
				case artifacts
				case buildRun
			...
			public enum FieldsCiIssues: String, Codable, CaseIterable, Hashable, Sendable {
				case category
				case fileSource
				case issueType
				case message
			...
			public enum FieldsCiBuildRuns: String, Codable, CaseIterable, Hashable, Sendable {
				case actions
				case buildRun
				case builds
				case cancelReason
			...
			public enum FieldsCiTestResults: String, Codable, CaseIterable, Hashable, Sendable {
				case className
			...
			public enum FieldsCiArtifacts: String, Codable, CaseIterable, Hashable, Sendable {
