...
extension APIEndpoint.V1.Apps.WithID {
	...
	public struct AppEvents {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.AppEventsResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "apps-appEvents-get_to_many_related")
		}
		...
		public struct GetParameters {
			...
			public enum FilterEventState: String, Codable, CaseIterable, Hashable, Sendable {
				case draft = "DRAFT"
