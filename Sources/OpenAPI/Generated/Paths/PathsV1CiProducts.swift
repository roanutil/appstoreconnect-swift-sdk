...
extension APIEndpoint.V1 {
	...
	public struct CiProducts {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.CiProductsResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "ciProducts-get_collection")
		}
		...
		public struct GetParameters {
			...
			public enum FilterProductType: String, Codable, CaseIterable, Hashable, Sendable {
				case app = "APP"
