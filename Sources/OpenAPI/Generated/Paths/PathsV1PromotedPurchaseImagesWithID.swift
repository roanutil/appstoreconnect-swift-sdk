...
extension APIEndpoint.V1.PromotedPurchaseImages {
	...
	public struct WithID {
		...
		public func get(fieldsPromotedPurchaseImages: [FieldsPromotedPurchaseImages]? = nil, include: [Include]? = nil) -> Request<AppStoreConnect_Swift_SDK.PromotedPurchaseImageResponse> {
			Request(method: "GET", path: path, query: makeGetQuery(fieldsPromotedPurchaseImages, include), id: "promotedPurchaseImages-get_instance")
		}
		...
		public enum FieldsPromotedPurchaseImages: String, Codable, CaseIterable, Hashable, Sendable {
			case assetToken
			case assetType
			case fileName
			case fileSize
		...
		public func patch(_ body: AppStoreConnect_Swift_SDK.PromotedPurchaseImageUpdateRequest) -> Request<AppStoreConnect_Swift_SDK.PromotedPurchaseImageResponse> {
			Request(method: "PATCH", path: path, body: body, id: "promotedPurchaseImages-update_instance")
		}

		public var delete: Request<Void> {
			Request(method: "DELETE", path: path, id: "promotedPurchaseImages-delete_instance")
		}
	}
}
