...
extension APIEndpoint.V1.AppCustomProductPageLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.AppCustomProductPageLocalizationResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "appCustomProductPageLocalizations-get_instance")
		}
		...
		public func patch(_ body: AppStoreConnect_Swift_SDK.AppCustomProductPageLocalizationUpdateRequest) -> Request<AppStoreConnect_Swift_SDK.AppCustomProductPageLocalizationResponse> {
			Request(method: "PATCH", path: path, body: body, id: "appCustomProductPageLocalizations-update_instance")
		}

		public var delete: Request<Void> {
			Request(method: "DELETE", path: path, id: "appCustomProductPageLocalizations-delete_instance")
		}
	}
}
