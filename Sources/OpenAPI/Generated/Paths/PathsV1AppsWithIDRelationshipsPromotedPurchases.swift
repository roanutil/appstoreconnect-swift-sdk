...
extension APIEndpoint.V1.Apps.WithID.Relationships {
	...
	public struct PromotedPurchases {
		...
		public func get(limit: Int? = nil) -> Request<AppStoreConnect_Swift_SDK.AppPromotedPurchasesLinkagesResponse> {
			Request(method: "GET", path: path, query: makeGetQuery(limit), id: "apps-promotedPurchases-get_to_many_relationship")
		}
		...
		public func patch(_ body: AppStoreConnect_Swift_SDK.AppPromotedPurchasesLinkagesRequest) -> Request<Void> {
			Request(method: "PATCH", path: path, body: body, id: "apps-promotedPurchases-replace_to_many_relationship")
		}
	}
}
