...
extension APIEndpoint.V1.BundleIDs {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.BundleIDResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "bundleIds-get_instance")
		}
		...
		public struct GetParameters {
			...
			public enum FieldsBundleIDCapabilities: String, Codable, CaseIterable, Hashable, Sendable {
		...
		public func patch(_ body: AppStoreConnect_Swift_SDK.BundleIDUpdateRequest) -> Request<AppStoreConnect_Swift_SDK.BundleIDResponse> {
			Request(method: "PATCH", path: path, body: body, id: "bundleIds-update_instance")
		}

		public var delete: Request<Void> {
			Request(method: "DELETE", path: path, id: "bundleIds-delete_instance")
		}
	}
}
