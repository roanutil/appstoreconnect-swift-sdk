...
extension APIEndpoint.V1.BuildBundles.WithID {
	...
	public struct BuildBundleFileSizes {
		...
		public func get(fieldsBuildBundleFileSizes: [FieldsBuildBundleFileSizes]? = nil, limit: Int? = nil) -> Request<AppStoreConnect_Swift_SDK.BuildBundleFileSizesResponse> {
			Request(method: "GET", path: path, query: makeGetQuery(fieldsBuildBundleFileSizes, limit), id: "buildBundles-buildBundleFileSizes-get_to_many_related")
		}
		...
		public enum FieldsBuildBundleFileSizes: String, Codable, CaseIterable, Hashable, Sendable {
			case deviceModel
			case downloadBytes
			case installBytes
			case osVersion
