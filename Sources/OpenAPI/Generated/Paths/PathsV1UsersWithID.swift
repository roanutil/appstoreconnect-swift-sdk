...
extension APIEndpoint.V1.Users {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.UserResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "users-get_instance")
		}
		...
		public struct GetParameters {
			...
			public enum FieldsUsers: String, Codable, CaseIterable, Hashable, Sendable {
				case allAppsVisible
				case firstName
				case lastName
		...
		public func patch(_ body: AppStoreConnect_Swift_SDK.UserUpdateRequest) -> Request<AppStoreConnect_Swift_SDK.UserResponse> {
			Request(method: "PATCH", path: path, body: body, id: "users-update_instance")
		}

		public var delete: Request<Void> {
			Request(method: "DELETE", path: path, id: "users-delete_instance")
		}
	}
}
