...
extension APIEndpoint.V1.BetaTesters.WithID.Relationships {
	...
	public struct Apps {
		...
		public func get(limit: Int? = nil) -> Request<AppStoreConnect_Swift_SDK.BetaTesterAppsLinkagesResponse> {
			Request(method: "GET", path: path, query: makeGetQuery(limit), id: "betaTesters-apps-get_to_many_relationship")
		}
		...
		public func delete(_ body: AppStoreConnect_Swift_SDK.BetaTesterAppsLinkagesRequest) -> Request<Void> {
			Request(method: "DELETE", path: path, body: body, id: "betaTesters-apps-delete_to_many_relationship")
		}
	}
}
