...
extension APIEndpoint.V1.CiBuildActions.WithID {
	...
	public struct BuildRun {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.CiBuildRunResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "ciBuildActions-buildRun-get_to_one_related")
		}
		...
		public struct GetParameters {
			...
			public enum FieldsCiWorkflows: String, Codable, CaseIterable, Hashable, Sendable {
				case actions
			...
			public enum FieldsScmPullRequests: String, Codable, CaseIterable, Hashable, Sendable {
