...
extension APIEndpoint.V1.Apps.WithID {
	...
	public struct InAppPurchasesV2 {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.InAppPurchasesV2Response> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "apps-inAppPurchasesV2-get_to_many_related")
		}
		...
		public struct GetParameters {
			...
			public enum FilterInAppPurchaseType: String, Codable, CaseIterable, Hashable, Sendable {
