...
extension APIEndpoint.V1.AppStoreVersionExperimentTreatmentLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnect_Swift_SDK.AppStoreVersionExperimentTreatmentLocalizationResponse> {
			Request(method: "GET", path: path, query: parameters?.asQuery, id: "appStoreVersionExperimentTreatmentLocalizations-get_instance")
		}
		...
		public var delete: Request<Void> {
			Request(method: "DELETE", path: path, id: "appStoreVersionExperimentTreatmentLocalizations-delete_instance")
		}
	}
}
