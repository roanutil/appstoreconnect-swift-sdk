...
extension APIEndpoint.V1.SubscriptionAppStoreReviewScreenshots {
	...
	public struct WithID {
		...
		public func get(fieldsSubscriptionAppStoreReviewScreenshots: [FieldsSubscriptionAppStoreReviewScreenshots]? = nil, include: [Include]? = nil) -> Request<AppStoreConnect_Swift_SDK.SubscriptionAppStoreReviewScreenshotResponse> {
			Request(method: "GET", path: path, query: makeGetQuery(fieldsSubscriptionAppStoreReviewScreenshots, include), id: "subscriptionAppStoreReviewScreenshots-get_instance")
		}
		...
		public func patch(_ body: AppStoreConnect_Swift_SDK.SubscriptionAppStoreReviewScreenshotUpdateRequest) -> Request<AppStoreConnect_Swift_SDK.SubscriptionAppStoreReviewScreenshotResponse> {
			Request(method: "PATCH", path: path, body: body, id: "subscriptionAppStoreReviewScreenshots-update_instance")
		}

		public var delete: Request<Void> {
			Request(method: "DELETE", path: path, id: "subscriptionAppStoreReviewScreenshots-delete_instance")
		}
	}
}
